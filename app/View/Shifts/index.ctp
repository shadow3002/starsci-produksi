	...
	<tr>
		...
		<td><?php echo h($shift['Shift']['code']); ?>&nbsp;</td>
		<td><?php echo h($shift['Shift']['note']); ?>&nbsp;</td>
		<td><?php echo h($shift['Shift']['create_by']); ?>&nbsp;</td>
		<td><?php echo h($shift['Shift']['create_date']); ?>&nbsp;</td>
		<td><?php echo h($shift['Shift']['modified_by']); ?>&nbsp;</td>
		<td><?php echo h($shift['Shift']['modified_date']); ?>&nbsp;</td>
		<td class="actions">
