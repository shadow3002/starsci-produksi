...
<?php echo $this->Form->create('Printcoa'); ?>
	<fieldset>
		<legend><?php echo __('Edit Printcoa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Printcoa.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Printcoa.id'))); ?></li>
