		...
		<div id="iner1">
				...
				<?php echo $this->Form->create('Tbdownload', array('type' => 'file')); ?>
					<fieldset>
						<legend><?php echo __('Add MSDS'); ?></legend>
					<?php
						...
						<?php echo $this->Form->input('namafiledoc', array('type' => 'file', 'label'=>'.doc')); ?>
						<?php echo $this->Form->input('namafilepdf', array('type' => 'file', 'label'=>'.pdf')); ?>
