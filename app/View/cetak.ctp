				...
				<tr>
					<?php foreach ($reactors as $reactor): ?>
									...
									<?php $need = ($productionSchedule['ProductionSchedule']['create_date']);
										...
										?>
										<?php if(!empty($tanggalsenins)) { ?> <!--kalo nanti cetaknya mau pake border kaya aslinya dari sci berarti ini harunya di if nya pas mau cetak, di dalem lagi. kalo dalem nya gak pake border di field Product Liquiq (table utama) jadi ini di atas aja, kalo kosong isi tanggal senin ( gak ada record di tanggal tersebut) ya udah gk usah cetak apa2 di field Product Liquid nya. kosong aja jadinya gitu, kolom condensat dll ya gak usah di cetak jg. biarin aja. -->
										<?php if($tanggalproduksi == $tanggalsenins): ?>
											...
											<?php if($shift['Shift']['code'] ==  $productionSchedule['Shift']['code']){ ?>
												...
												?>
                                                                                                <td><?php echo 'Harusnya isi data CONDENSAT nya'; ?></td>
                                                                                                <td><?php echo 'Lot'; ?></td>
                                                                                                <td><?php echo 'Harusnya isi data RELABEL nya'; ?></td>
                                                                                                <td><?php echo 'Lot'; ?></td>
                                                                                                <td ><?php echo 'Harusnya isi data REPACKING nya'; ?></td>
                                                                                                <td><?php echo 'Lot'; ?></td>
											<?php }
											?>
...
<!--									<td>&nbsp<</td>
	...
	<td><!--ini harusnya di cek juga kalo gak ada record di hari ini ya gak usah cetak apa2. kosong aja nih td nya ( isi &nbsp aja biar ada spasi )-->
		<table style='border: none 0px #dddddd;'>
				<?php foreach ($shifts as $shift): ?>
				<tr>
					<td><?php echo 'REMARKS'; ?></td>
									...
									<?php $need = ($productionSchedule['ProductionSchedule']['create_date']);
										...
										<?php if($tanggalproduksi == $tanggalrabus): ?>
											...
											<?php if($shift['Shift']['code'] ==  $productionSchedule['Shift']['code']){ ?>
												...
												?>
                                                                                                <!--ini di cetak di akhir looping $productionSchedule, artinya memang sudah selesai, jadi buntutnya harus cetak ini
                                                                                                <td><?php echo 'Harusnya isi data CONDENSAT nya'; ?></td>
                                                                                                <td><?php echo 'Lot'; ?></td>
                                                                                                <td><?php echo 'Harusnya isi data RELABEL nya'; ?></td>
                                                                                                <td><?php echo 'Lot'; ?></td>
